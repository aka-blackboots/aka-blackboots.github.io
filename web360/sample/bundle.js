...
class Camera360 {
    ...
    setupCamera() {
        this.camera = new PerspectiveCamera(75, this.web360Context.getContainer().clientWidth / this.web360Context.getContainer().clientHeight, 0.1, 1000);
...
(function (TransitionType) {
    TransitionType[TransitionType["ZoomIn"] = 0] = "ZoomIn";
    TransitionType[TransitionType["ZoomOut"] = 1] = "ZoomOut";
